...
new_cardinal13_block <- function(
  ...
  fields <- list(
    ...
    min_freq = new_numeric_field(min_freq, min = 0, max = 100, title = "Mininum frequency")
  )
  ...
  expr <- quote({
    ...
    rtables <- cardinal::make_table_13(
      adae = data,
      arm_var = arm_var,
      saffl_var = saffl_var,
      id_var = id_var,
  ...
  blockr::new_block(
    ...
    fields = fields,
    ...,
    class = c("cardinal13_block", "rtables_block", "submit_block")
  )
}
