...
new_cardinal07_block <- function(
  ...
  fields <- list(
    ...
    na_level = new_text_field(na_level, title = "Explicit NA level"),
  ...
  expr <- quote({
    ...
    rtables <- cardinal::make_table_07(
      adae = data,
  ...
  blockr::new_block(
    ...
    fields = fields,
    ...,
    class = c("cardinal07_block", "rtables_block", "submit_block")
  )
}
