...
#' @export
new_cardinal38_block <- function(
  ...,
  id_var = character(),
  arm_var = character(),
  saffl_var = character(),
  trtemfl_var = character(),
  fmqsc_var = character(),
  ...
  fields <- list(
    ...
    trtemfl_var = new_select_field(trtemfl_var, all_cols, title = "Treatment Flag"),
  ...
  expr <- quote({
    ...
    trtemfl_var <- get_column_default(data, .(trtemfl_var), "TRTEMFL")
    ...
    rtables <- cardinal::make_table_38(
      adae = data,
      arm_var = arm_var,
      show_colcounts = .(show_colcounts),
      saffl_var = saffl_var,
      trtemfl_var = trtemfl_var,
      id_var = id_var,
      pref_var = pref_var,
      fmq_scope = .(fmq_scope),
      fmqsc_var = fmqsc_var,
  ...
  blockr::new_block(
    ...
    fields = fields,
    ...,
    class = c("cardinal38_block", "rtables_block", "submit_block")
  )
}
