...
#' @export
new_cardinal20_block <- function(
  ...,
  id_var = character(),
  arm_var = character(),
  saffl_var = character(),
  aesifl_var = character(),
  aelabfl_var = character(),
  pref_var = character(),
  show_colcounts = TRUE,
  prune_0 = TRUE
){
  ...
  fields <- list(
    ...
    aesifl_var = new_select_field(aesifl_var, all_cols, title = "AESIFL"),
    aelabfl_var = new_select_field(aelabfl_var, all_cols, title = "AE Label"),
  ...
  expr <- quote({
    ...
    pref_var <- get_column_default(data, .(saffl_var), "AEDECOD")
    aelabfl_var <- get_column_default(data, .(aelabfl_var), "AELABFL")
    aesifl_var <- get_column_default(data, .(aesifl_var), "AESIFL")

    rtables <- cardinal::make_table_20(
      adae = data,
      arm_var = arm_var,
      ...
      id_var = id_var,
      pref_var = pref_var,
      aesifl_var = aesifl_var,
      aelabfl_var = aelabfl_var,
      prune_0 = .(prune_0)
    )
  ...
  blockr::new_block(
    ...
    fields = fields,
    ...,
    class = c("cardinal20_block", "rtables_block", "submit_block")
  )
}
